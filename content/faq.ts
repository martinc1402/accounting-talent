...
export const faq: FaqItem[] = [
  ...
  },
  {
    ...
    a: [
      "Make sure the email on your application is correct. It's how everything reaches you. Shortlisted applicants receive the skills assessment by email within 3 days. Pass it and your profile is marked Verified and shown first when US\u00A0firms begin hiring in late 2026 (October to December). We email you at launch either way.",
    ],
  },
  {
    id: "timing",
